...
export const dashboardItems=[
 ...
 {href:"/admin/appearance",label:"Walk photo",access:"manager"},
 {href:"/admin/cities",label:"Cities",access:"admin"},
 {href:"/admin/invitations",label:"Invite organizers",access:"admin"},
] as const;
export function dashboardNavigation(role:DashboardRole){return dashboardItems.filter(item=>item.access==="all"||item.access==="connected"&&role!=="disconnected"||item.access==="manager"&&(role==="organizer"||role==="super-admin")||item.access==="admin"&&role==="super-admin");}
